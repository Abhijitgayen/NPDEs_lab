...
plot(log(h),log(inf_error),'-*',log(h),log(h)+log(h(length(N))),'--');
legend(' log norm-error','o(k)')

% odservation theoritical o(k^2) but numarical code give us o(k)
%this is happening for big R value. and also for rouding error.